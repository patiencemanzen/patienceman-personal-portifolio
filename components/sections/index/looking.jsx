	...
	return (
		<Section classProp={`${looking.section} borderBottom`}>	
			<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
				...
				<h2 className={looking.jsonSub}><span className={looking.highlight}>Backend Developer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Frontend Developer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Database Expert</span></h2>
				<h2 className={looking.json}>&#125;</h2>
