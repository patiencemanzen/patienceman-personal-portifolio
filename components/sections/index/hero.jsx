  ...
  return (
    <Section classProp={`${hero.section}`}>
      	<Container spacing={"VerticalXXXL"}>
			...
			<section>
				<button className={`button ${button.primary}`} onClick={() => (window.location = "mailto:hseal419@gmail.com")}>
					{content.buttons.primary.title}
				</button>
				<button className={`button ${button.secondary} leaveSite`} onClick={() => window.open(
					"https://www.linkedin.com/in/manirabona-patience",
					"_blank"
				)}>
					{ content.buttons.secondary.title }
				</button>
				<button className={`button ${button.download} leaveSite`} onClick={() => window.open(
